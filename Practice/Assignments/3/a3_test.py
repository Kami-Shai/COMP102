...
class Assign3NewsStory(unittest.TestCase):
    def setUp(self):
        pass
...
class Assign3(unittest.TestCase):
    def setUp(self):
        class TrueTrigger:
    ...
    def test3BeforeAndAfterTrigger(self):
        ...
        just_now_time = now - dt
        just_now = NewsStory('', '', '', '', just_now_time)
        
        in_a_bit_time = now + dt
        in_a_bit = NewsStory('', '', '', '', in_a_bit_time)
...
if __name__ == "__main__":
    ...
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(Assign3NewsStory))
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(Assign3))
